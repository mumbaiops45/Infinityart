         ...
         <div className="contact-grid" >
            ...
            <div>
              ...
              <div style={{ marginTop: 28, display: "flex", flexDirection: "column", gap: 20 }}>
                {[
                  ["📍", "Address", "Infinity Art PMC Engineering Services\nA1203 Riddhi Siddhi Sec.3 New Panvel, Navi Mumbai - 420206"],
                  ["📞", "Phone", "+9769465042\n+91 9082697924"],
                  ["✉️", "Email", "gurunalat@gmail.com"],
      ...
      <section className="section-alt">
        <div className="container">
          ...
          <div style={{ borderRadius: 14, overflow: "hidden", border: `1px solid ${C.border}`, height: 360, background: `linear-gradient(135deg,${C.bluePale},${C.gray200})`, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: C.blue }}>A1203 Riddhi Siddhi Sec.3 New Panvel, Navi Mumbai - India</div>
            <div style={{ fontSize: 14, color: C.muted }}>Embed Google Maps here by replacing this section with an &lt;iframe&gt; tag</div>
            <a href="https://www.google.com/maps/search/?api=1&query=19.0026318%2C73.1209983" target="_blank" rel="noopener noreferrer" style={{ background: C.blue, color: "#fff", textDecoration: "none", fontSize: 13, fontWeight: 600, padding: "10px 22px", borderRadius: 8 }}>Open in Google Maps →</a>
          </div>
        </div>
      </section>
    </>
