...
export const PROJECTS = [
  ...
  {
    slug: "Al-akka", name: "Al akka Beach Resort – B+G+27 Story 5 Star Hotel for Emirates Airlines", type: "Residential", image: "/assets/akka.png", area: "1.5L sqft", location: "Fujairah, U.A.E  ", status: "Completed", year: 2024, value: " $755 Million,", desc: " Consist of state-of-the-Art Guest Rooms consist of all modern amenities, Olympic size Swimming Pool next to Beach, Air Cooled Chiller System, Hydropneumatics Water supply system, Power, Lighting, LV System, LPG distribution, Commercial Steam Laundry systems, Commercial Kitchen equipment’s installation and supply, Hot water Boiler system. " },
