...
export const PROJECTS = [
  { slug: "infinity-heights", name: "Infinity Heights Residences", type: "Residential", image: "/assets/infinity1.jpg" ,area: "4.2L sqft", location: "Bengaluru", status: "Completed", year: 2022, value: "₹142 Cr", desc: "A premium 300-unit residential complex across 3 towers, delivered on time and within budget despite mid-project design changes." },
  { slug: "arttech-campus", name: "ArtTech Corporate Campus", type: "Commercial", image: "/assets/arttech.jpg" , area: "2.8L sqft", location: "Hyderabad", status: "Completed", year: 2023, value: "₹98 Cr", desc: "4-block IT campus for a leading tech firm, delivered in 18 months through aggressive phased planning and zero quality defects." },
  { slug: "horizon-convention", name: "Horizon Convention Centre", type: "Institutional", image: "/assets/horizon.jpg", area: "1.5L sqft", location: "Chennai", status: "Ongoing", year: 2024, value: "₹64 Cr", desc: "A state-of-the-art convention centre with complex MEP and acoustic requirements being managed with precision." },
  { slug: "elara-township", name: "Elara Mixed-Use Township", type: "Township", image: "/assets/elara.webp", area: "6.1L sqft", location: "Bengaluru", status: "Completed", year: 2021, value: "₹280 Cr", desc: "Largest township project in our portfolio — residential, retail, and amenity blocks delivered across 3 phases." },
